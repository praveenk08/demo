       ...
       <form role="form" id="copy_product_product_form">
          ...
          <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" name="sku" id="sku" placeholder="SKU" readonly value="<?php echo $product['sku'];?>">
                  <span id="sku_error" class="error"></span>
                </div>
                <div class="form-group col-md-4">
                <label for="Select Category">Select Parent Category</label><br>
              ...
              $product_categories=explode(',',$product['product_categories']);
                ...
                <div class="form-group col-md-4">
                 ...
                 <div class="form-group col-md-<?php if(is_file('attachments/products/thumb/'.$product['image'])){echo "4"; }else{ echo "8";} ?>" >
