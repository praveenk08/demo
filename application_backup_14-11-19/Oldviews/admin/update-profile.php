       ...
       <form role="form" id="update_profile_form">
              ...
              <div id="success_message"><?php if($this->session->flashdata('success_message')){ ?> 
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="password" class="form-control" id="admin_password" name="admin_password" placeholder="Password" value="">
                  <span id="admin_password_error" class="error"></span>
                </div>
                <div class="form-group col-md-6">
                  <label for="Password">Confirm Password</label>
                  <input type="password" class="form-control" id="confirm_admin_password" name="confirm_admin_password" placeholder="Confirm Password" value="">
              ...
              <a href="<?php echo base_url('admin');?>" type="button" class="btn btn-primary">Cancel</a>
              </div>
            </form>
            </div>
          </div>
