<?php
function sendEmail($to,$from,$subject,$message,$cc=array('sumishra@panindia.in'),$bcc=array('ankumar@panindia.in'),$attachments=array()) {
...
function uploadImage($module,$allowed_types,$name,$old_image){
