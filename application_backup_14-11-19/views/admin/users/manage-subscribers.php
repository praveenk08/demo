        ...
        <form method="post">
          ...
          <div class="row">
           <div class="col-md-3 col-sm-6 form-group">
            <input type="text" class="form-control" id="search" name="search" placeholder="Search Email">
            </div>
...
<script>
 var subscribers_list_table='';
    $(function () { 
      ...
      $("#export_subscribers").click(function(){
        var a = confirm("Do you want to export ??");
        if( a== true )
        {
        location.replace("<?php echo base_url('admin/users/exportSubscribers')?>");
         }   
