   ...
   <div class="box box-primary">
       <div class="box-body">
         <div class="row">
            ...
            <div class="col-md-6">
               <div class="outerData">
                  <div class="innerData1">Mobile</div>
                  <div class="innerData2"><?php echo $student['phone'];?></div>
               </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="outerData">
                  <div class="innerData1">Regigstration No</div>
                  <div class="innerData2"><?php echo $student['registrationno'];?></div>
               </div>
            </div>
             ...
             <div class="col-md-6">
               <div class="outerData">
                  ...
                  <div class="innerData2">
                     <div class="prdImg">
                        <?php if(is_file('attachments/student/thumb/'.$student['image'])){ ?><img src="<?php echo base_url('attachments/student/thumb/'.$student['image'])?>"  class="img-responsive"><?php } ?>
                     </div>
                  </div>
                  <div>
             </div>
