            ...
            <div class="row">
               ...
               <div id="calender_part" class="col-md-4 col-sm-8" style="display:none;"></div>
                ...
                <div class="col-md-2 form-group">
                  <input type="submit" name="export" class="btn btn-primary" id="export" value="Export File">
      ...
      "columnDefs": [
        {
          ...
          },
          {
            "render": function ( data, type, row ) {
              if(data==1){
               return '<span class="btn-success">PAID</span>';
              }else{
                return '<span class="btn-danger">UNPAID</span>';
              }
          },
           "targets": 8 
          },
