      ...
      <div class="tableTop">
        <form method="post">
          <div class="row">
            ...
            <select class="form-control" id="change_rating" name="change_rating">
            ...
            <div class="col-md-3 form-group"><input type="text" class="form-control" id="search" name="search" placeholder="Search Customer Name/Review"></div>
...
"scrollX": true,
    ...
    "ajax":{
      url :"<?php echo base_url('vendor-manage-review-ajax')?>", 
      type: "post", 
      data: function (d) {      
    ...
    $('#change_status,#change_rating').change(function(){
    ...
    $('#delete_record').click(function(){
			actionPerform('<?php echo base_url('vendor-delete-review')?>',review_list_table);
    });
...
function updateReview(id){
  ...
  if(review_show_status==0){
    ...
    function changeReviewtatus(id,status){
	    if(id>0){
        changeDataStatus('changeReviewtatus',id,status,'<?php echo base_url('vendor-change-review-status')?>',review_list_table);
    }
  } 
  ...
  function setRating(rating,id){
    ...
    $.ajax({
      url: '<?php echo base_url('vendor-change-rating');?>',
      type: "POST",
  ...
  function updateReviewData(id){
    ...
    $.ajax({
      url: '<?php echo base_url('vendor-update-rating');?>',
      type: "POST",
