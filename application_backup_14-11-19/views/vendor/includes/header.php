      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
         ...
         <li class="treeview">
          ...
          <li><a href="<?php echo base_url('vendor-manage-reviews');?>">Manage Reviews</a></li>
          <li><a href="<?php echo base_url('vendor-weather-forecast');?>">Weather Forecast</a></li>
        ...
        <li class="treeview">
          ...
          <li><a href="<?php echo base_url('vendor-manage-customers');?>">Manage Customers</a></li>
           </ul>
        </li>
