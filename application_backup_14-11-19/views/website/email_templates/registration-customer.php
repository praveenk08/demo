			...
			<tr>
				<td align="center">
					<table border="0" cellpadding="0" cellspacing="0" width="600" align="center">
							...
							<td align="center" style="background-color: #fff;">
								...
								?>
 								 <img src="<?php echo base_url('attachments/email-templates/main/'.$email_data['banner_image'])?>">
									...
									?>
								<img src="http://mahaseel.us.tempcloudsite.com//assets/frontend/images/banner01.jpg" style="width:100%;">
										<?php
									}
									?>
								</p>
						...
						<tr><td><img src="http://mahaseel.us.tempcloudsite.com//assets/frontend/images/banner02.jpg" style="width:100%;"></td></tr>
					</table>
				</td>
			</tr>
