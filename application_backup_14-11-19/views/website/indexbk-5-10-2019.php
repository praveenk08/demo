								...
								<div class="hs1">
											...
											<div class="inputDropdown">
												...
												<li class="nav-item dropdown"><a  class="nav-link select_cate" is_parent="1" id="0" name="">Select your Crop</a></li>
													...
													<li class="nav-item dropdown">
														<a  class="nav-link select_cate" name="<?php echo $cat['name'];?>" id="<?php echo $cat['id'];?>"  is_parent="1" ><?php echo $cat['name'];?></a>
														<span class="dropIcon"><i class="fa fa-angle-right"></i></span>
														<ul class="dropdown-menu">
															<?php
															foreach($cat['sub_category'] as $sub_category){
																?>
																<li class="nav-item"><a  class="nav-link select_cate" name="<?php echo $sub_category['name'];?>" id="<?php echo $sub_category['id'];?>" is_parent="0"  ><?php echo $sub_category['name'];?></a></li>
																<?php
															}
															?>
														</ul>
													...
													<?php
														...
														?>
														<li class="nav-item"><a  class="nav-link select_cate" name="<?php echo $cat['name'];?>" id="<?php echo $cat['id'];?>" is_parent="1" ><?php echo $cat['name'];?></a></li>
														<?php
													}
									...
									<div class="hs2">
										...
										<div class="inputDropdown">
												...
												<li class="nav-item dropdown"><a  class="nav-link select_service" name=""  id="0" is_parent="1" >Select Service Category</a></li>
													<?php
													...
													?>
													<li class="nav-item dropdown">
														<a  class="nav-link select_service" name="<?php echo $service_cat['name'];?>" id="<?php echo $service_cat['id'];?>"  is_parent="1" ><?php echo $service_cat['name'];?></a>
														<span class="dropIcon"><i class="fa fa-angle-right"></i></span>
														<ul class="dropdown-menu">
															<?php
															foreach($service_cat['sub_category'] as $sub_category){
																?>
																<li class="nav-item">
																<a    class="nav-link select_service" name="<?php echo $sub_category['name'];?>"  id="<?php echo $sub_category['id'];?>" is_parent="0"><?php echo $sub_category['name'];?></a>
 																</li>
																<?php
															}
															?>
													...
													<?php
														...
														?>
														<li class="nav-item"><a  class="nav-link select_service" name="<?php echo $service_cat['name'];?>" id="<?php echo $service_cat['id'];?>"  is_parent="1"   ><?php echo $service_cat['name'];?></a></li>
														<?php
													}
												}
												?>
					...
					<div class="msProcess">
						...
						<?php
							foreach($how_it_works as $how_it_work){
								...
								<?php if(is_file('attachments/work-process/thumb/'.$how_it_work['image'])){ ?>
											<figure>
											<img src="<?php echo base_url('attachments/work-process/thumb/'.$how_it_work['image'])?>">
											</figure>
 										<?php } ?>
		...
		$(function(){
			...
			$('.select_cate').click(function(){
				...
				if(name!=''){
					...
					$('#home_page_search_form').attr('action', '<?php echo base_url('products');?>');
				}else{
			...
			$('.select_service').click(function(){
				...
				if(name!=''){
					...
					$('#search_button').removeAttr("disabled");
					$('#home_page_search_form').attr('action', '<?php echo base_url('services');?>');
				}else{
