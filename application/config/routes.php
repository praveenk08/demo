...
$route['admin-remove-login-registration-banner'] = "admin/Page/removeLoginRegistrationBanner";
$route['admin-remove-arabic-logo'] = "admin/Page/removeArabicLogo";
...
//Why choose us
$route['admin-manage-why-choose'] = "admin/Brand/whyChoose";
$route['admin-manage-why-choose-ajax'] = "admin/Brand/manageWhyChooseAjax";
$route['admin-change-why-choose-status'] = "admin/Brand/changeWhyChooseStatus";
$route['admin-delete-why-choose'] = "admin/Brand/deleteWhyChoose";
$route['admin-add-why-choose'] = "admin/Brand/addUpdateWhyChoose";
$route['admin-update-why-choose/(:num)'] = "admin/Brand/addUpdateWhyChoose/$1";
$route['admin-add-update-why-choose'] = "admin/Brand/saveWhyChoose";
$route['admin-delete-why-choose-image'] = "admin/Brand/deleteWhyChooseImage";
$route['admin-view-why-choose/(:num)'] = "admin/Brand/viewWhyChoose/$1";
...
$route['admin-manage-notifications'] = "admin/Users/notifications";
$route['admin-manage-notifications-ajax'] = "admin/Users/manageNotificationsAjax";
$route['admin-delete-publications'] = "admin/Users/deleteNotifications";


//Matching and Connections

$route['admin-manage-matching-and-connections/(:num)'] = "admin/Users/matchingAndConnection/$1";
$route['admin-manage-matching-and-connections-ajax'] = "admin/Users/matchingAndConnectionAjax";
$route['admin-change-manage-matching-and-connections-status'] = "admin/Users/changeMatchingAndConnectionStatus";

//admin-add-update-matching-and-connections
...
$route['admin-change-rating'] = "admin/Review/changeRating";
$route['admin-update-rating'] = "admin/Review/updateRating";
$route['admin-manage-transactions'] = "admin/Orders/manageTransactions";
$route['admin-manage-transaction-ajax'] = "admin/Orders/manageTransactionsAjax";
...
$route['vendor-manage-notifications'] = "vendor/Vendor/notifications";
$route['vendor-manage-notifications-ajax'] = "vendor/Vendor/manageNotificationsAjax";
...
$route['customer-delete-matching-and-connection'] = "Customer/deleteMatchingAndConnectionProduct";
$route['customer-remove-image']='Customer/removeProfilePhoto';
$route['customer-matching-and-connections']='Customer/matchingAndConnections';
$route['customer-save-product']='Customer/saveProduct';
$route['customer-new-product-request'] = "Customer/newProductRequest";
$route['customer-save-new-product-request'] = "Customer/saveNewProductRequest";
$route['matching-and-connections']='Website/matchingAndConnections';
$route['matching-and-connections/(:any)'] = "Website/matchingAndConnections/$1";
...
$route['registration-step-three']='Website/registrationStepThree';
