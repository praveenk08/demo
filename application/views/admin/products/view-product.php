	...
	<section class="content ViewProduct">
		...
		<div class="box box-primary">
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="outerData">
							...
							<div class="innerData2"><?php echo $product['product_parent_category_name'];?></div>
						</div>
					</div>

					<div class="col-md-12">
						<div class="outerData">
						<div class="innerData1">Sub Category</div>
					...
					<div class="col-md-4">
						<div class="outerData">
							<div class="innerData1">Maturity From Date</div>
							<div class="innerData2"><?php echo $product['maturity_date'];?></div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="outerData">
							<div class="innerData1">Maturity To Date</div>
							<div class="innerData2"><?php echo $product['maturity_to_date'];?></div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="outerData">
			...
			<div class="box-footer">
				<a href="<?php echo base_url('admin-manage-products')?>" class="btn btn-primary">Back</a>
			</div>
		</div>
	</section>
