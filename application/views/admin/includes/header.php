     ...
     <!-- <div class="user-panel">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <li><a href="<?php echo base_url('admin-manage-why-choose');?>">Manage Why Choose Us</a></li>
            </ul>
        </li>
        <li class="treeview">
          ...
          <li><a href="<?php echo base_url('admin-manage-notifications');?>">Manage Notifications</a></li>
          ...
          <li><a href="<?php echo base_url('admin-manage-transactions');?>">Manage Transactions</a></li>
            </ul>
        </li>
      </ul>
    </section>
