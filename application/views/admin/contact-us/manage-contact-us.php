       ...
       <div class="tableTop"> 
        <form method="post"> 
          ...
          <div class="row">
           ...
           <div class="col-md-3 col-sm-6 form-group">
           <input type="text" class="form-control" id="search" name="search" placeholder="Search Customer Name/Email/Phone">
            </div>
            <div class="col-md-2 form-group">
              <input type="submit" class="btn btn-primary" id="exportcontactus" name="export" value="Export Files">
            </div>            
        </div>
      </form>
