        ...
        <form role="form" id="add_update_slider_form">
          <div class="box-body">
                ...
                <div class="form-group col-md-4">
                  <div id="image_preview">
                    <?php if(is_file('attachments/sliders/thumb/'.$slider['image'])){
                      ...
                      <input type="hidden" name="old_image" id="old_image" value="<?php echo $slider['image'];?>">
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url('admin-manage-sliders');?>" type="button" class="btn btn-danger">Cancel</a>
            </div>
          </form>
        </div>
      </section>
