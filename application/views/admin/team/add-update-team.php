            ...
            ?>
                ...
                <?php
                  ...
                  <div class="set_language" id="set_language<?php echo $language['abbr'];?>">
                    <label for="Team Name">Team Name (<?php echo ucfirst($language['name']);?>)</label>
                ...
                <?php
                  ...
                  <div class="set_language" id="set_language2<?php echo $language['abbr'];?>">
                    <label for="Designation">Designation (<?php echo ucfirst($language['name']);?>)</label>
                    <input type="text" class="form-control"  name="designation<?php echo $language['abbr'];?>" id="designation<?php echo $language['abbr'];?>" placeholder="Designation" value="<?php if(isset($names[$language['abbr']]['designation'])){echo $names[$language['abbr']]['designation'];}?>">
                      <span id="name<?php echo $language['abbr'];?>_error" class="error"></span>
                  </div>
                  <?php
                    }
