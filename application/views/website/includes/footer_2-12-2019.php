								...
								<div class="footContent footLink">
									...
									<?php
											...
											foreach($categories as $category){
											 ...
											 if($sr==5){
												 ?>
												 <i id="show_more" ><b><?php echo $show_more;?></b></i>
												 <?php
											 }
											 if($total_cat==$sr){
												?>
												<i id="show_less" style="display:none;"><b><?php echo $show_less;?></b></i>
												<?php
											 }
											 $sr ++;
									...
									<?php
											...
											foreach($categories as $category){
											 ...
											 if($total_cat==$sr){
												?>
												<i id="show_less" style="display:none;"><b><?php echo $show_lass;?></b></i>
												<?php
											 }
											 $sr ++;
									...
									<ul>
										<?php
												...
												foreach($service_categories as $service_category){
													...
													if($sr==5){
														?>
														<i id="show_more1" ><b><?php echo $show_more;?></b></i>
														<?php
													}
													if($total_service==$sr){
													 ?>
													 <i id="show_less1" style="display:none;"><b><?php echo $show_lass;?></b></i>
													 <?php
													}
													$sr ++;
												}
