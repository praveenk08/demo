							...
							<ul class="d-flex flex-wrap align-items-center">
								<li class="myAccount">
									...
									if($this->session->userdata('role_id')){
										...
										<a href="<?php echo base_url('registration-step-one');?>">تسجيل
</a>
 										<?php
										}
										?>
								...
								<ul class="navbar-nav navbar-right">
									<li class="nav-item">
										...
										if($this->session->userdata('language')=='en'){
											...
											?>
											<a class="nav-link" href="<?php echo base_url();?>">الصفحة الرئيسية</a>
											<?php
										}
										?>
									...
									<?php
										...
										<a class="nav-link" href="<?php echo base_url('about-us');?>">About us</a>
											...
											?>
											<a class="nav-link" href="<?php echo base_url('about-us');?>">معلومات عنا
</a>
											<?php
										}
										?>
									...
									<li class="nav-item">
										...
										<a class="nav-link" href="<?php echo base_url('our-team');?>">Our team</a>
											...
											?>
											<a class="nav-link" href="<?php echo base_url('our-team');?>">فريقنا</a>
											<?php
										}
										?>
									...
									<li class="nav-item">
										...
										<a class="nav-link" href="<?php echo base_url('contact-us');?>">Contact us</a>
											...
											?>
											<a class="nav-link" href="<?php echo base_url('contact-us');?>">اتصل بنا
</a>
											<?php
										}
										?>
