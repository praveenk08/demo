<?php
   ...
   if($this->session->userdata('language')=='en'){
      $home_label="Home";
      $address_label="Address List";
   }else{
      $home_label="الصفحة الرئيسية";
      $address_label="قائمة العناوين";
   }
   ?>
<!-- Main body wrapper -->
<div class="mainBody">
   <div class="msBreadcrumb">
      <div class="container-fluid">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><?php echo $address_label;?></li>
         </ol>
      </div>
   </div>
...
<script>
   ...
   $('#change_city,#change_status').change(function(){
      searchFilter(0);
    });
