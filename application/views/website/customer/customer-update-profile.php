<?php
   ...
   if($this->session->userdata('language')=='en'){
      ...
      $update_profile_label="تحديث الملف";
    }
   ?>
<!-- Main body wrapper -->
<div class="mainBody">
                                 ...
                                 <div class="personalInfo">
                                    ...
                                    <form id="update_customer_profile_form"  role="form">
                                       ...
                                       <div class="row form-group">
                                        ...
                                        <!-- <div class="row form-group">
                                          <label class="col-sm-4">Publication Notifications:<span class="mandatory">*</span></label>
                                          <div class="col-sm-4">
                                             <select class="form-control" name="publication_notification_status">
                                             <option value="0" <?php //if($this->session->userdata('customer_data')['publication_notification_status']==0){ echo "Selected";}?>>OFF</option>
                                             <option value="1" <?php //if($this->session->userdata('customer_data')['publication_notification_status']==1){ echo "Selected";}?>>ON</option>
                                       ...
                                       <div class="row form-group">
                                          <label class="col-sm-4">Matching and Connections Status:<span class="mandatory">*</span></label>
                                          <div class="col-sm-4">
                                             <select class="form-control" name="matching_and_connections_status">
                                             <option value="0" <?php if($this->session->userdata('customer_data')['matching_and_connections_status']==0){ echo "Selected";}?>>OFF</option>
                                             <option value="1" <?php if($this->session->userdata('customer_data')['matching_and_connections_status']==1){ echo "Selected";}?>>ON</option>
