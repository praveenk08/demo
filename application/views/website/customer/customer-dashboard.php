									...
									<div class="tab-content">
										...
										<div class="tab-pane active" id="myProfile">
											<div class="myProfile">
											 ...
											 ?>
											 <div class="myImg">
														<img src="<?php echo base_url('attachments/users/thumb/'.$this->session->userdata('customer_data')['image'])?>">
													</div>
                                              <?php
                                                }
                                                ?>
													<div class="myInfo">
														<div class="personalInfo">
															...
															<div class="row form-group">
																...
																<div class="col-sm-9"><?php echo $this->session->userdata('customer_data')['first_name'];?></div>
															</div>
															<div class="row form-group">
																<label class="col-sm-3">last Name:</label>
																<div class="col-sm-9"><?php echo $this->session->userdata('customer_data')['last_name'];?></div>
															</div>
															<div class="row form-group">
																<label class="col-sm-3">Phone:</label>
																<div class="col-sm-9"><?php echo $this->session->userdata('customer_data')['phone'];?></div>
															</div>
															<div class="row form-group">
																<label class="col-sm-3">Email:</label>
																<div class="col-sm-9"><?php echo $this->session->userdata('customer_data')['email'];?></div>
															</div>
