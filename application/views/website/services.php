<?php
			 ...
			 if($this->session->userdata('language')=='en'){
				$home_label="Home";
				$shop_label="Shop";		
				$service_category_label="Service Categories";
				$new_label="New";
				...
				$shop_label="متجر";		
				$service_category_label="فئات الخدمة";	
				$new_label="الجديد";	
				...
				<div class="msBreadcrumb">
					<div class="container-fluid">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><?=$shop_label;?></li>
						</ol>
					</div>
				</div>
							...
							<div class="prdRt">
								...
								<div class="prdContent">
									<div class="mb-3">	
											...
											<?php
									if(is_file('attachments/pages/main/'.$settings['service_banner']) && 1==2 ){
										?>
 									<img src="<?php echo base_url('attachments/pages/main/'.$settings['service_banner'])?>">
									<?php
									}else{
										?>
