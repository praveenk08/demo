...
<html>
	...
	<?php
		...
		$role_array=array('3'=>'Customer','2'=>'Grower','5'=>'Service Provider','4'=>'Delivery Agents');
	?>
							...
							<form id="registration_form">
								...
								<div class="row">
									...
									<div class="col-sm-12 form-group">
										...
										<input type="text" class="form-control" minlength="5" maxlength="15" id="phone" placeholder="Phone*" name="phone">
									...
									<div class="col-sm-12 form-group">
										...
										<input type="text" class="form-control" id="address" placeholder="Address*" name="address" autocomplete="off" value="<?php echo $change_address;?>">
