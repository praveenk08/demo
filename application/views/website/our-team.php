			...
			if($this->session->userdata('language')=='en'){
				$our_team_heading="Our Creative Team";
				$view_bio_heading="View Bio";
			}else{
				$our_team_heading="لدينا فريق الإبداعية";
				$view_bio_heading="عرض السيرة الذاتية";
			}
				...
				<div class="teamWrapper">
					<div class="container-fluid">
						<div class="teamContainer">
							<h4 class="mb-4 text-center"><strong><?php echo $our_team_heading;?></strong></h4>
							<div class="row">
							<?php
										...
										<div class="teamContent">
											<div class="teamInfo">
												...
												<div class="d-flex flex-wrap align-items-center">
													<a href="javascript:void(0)" class="btn bioBtn"onClick="showDetail('<?php echo $team['id'];?>')"><?php echo $view_bio_heading;?></a>
