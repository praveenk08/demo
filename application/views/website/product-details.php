<?php
	...
	if($this->session->userdata('language')=='en'){
		...
		$maturity_date_label="Maturity Start Date";
		$maturity_to_date_label="Maturity End Date";
		...
		$review_label="التعليقات";
		$maturity_date_label="تاريخ بدء الاستحقاق";
		$maturity_to_date_label="تاريخ انتهاء الاستحقاق";
		$in_stock_label="في المخزن";
			...
			<div class="mainBody">
				<div class="msBreadcrumb">
					<div class="container-fluid">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo base_url('cart');?>"><?php echo $home_label;?></a></li>
							<li class="breadcrumb-item active"><?php echo $product_label;?></li>
						</ol>
					</div>
				</div>
					...
					<div class="container-fluid">
								...
								<div class="col-md-5">
 								...
 								<div class="col-md-7">
									<div class="detailContent">
										...
										<div class="stock"><i class="fas fa-check-circle"></i>&nbsp;<span><?php echo $product['quantity'];?> <?php echo $in_stock_label;?></span></div>
										<div class="maturityDate"><span> <?php echo $maturity_date_label;?>:</span>&nbsp;<strong><?php echo date('d-m-Y',strtotime($product['maturity_date']));?></strong></div>
										<div class="maturityDate"><span> <?php echo $maturity_to_date_label;?>:</span>&nbsp;<strong><?php echo date('d-m-Y',strtotime($product['maturity_to_date']));?></strong></div>
										...
										<div class="prdBottom d-flex flex-wrap text-nowrap">
											...
											<div class="addToCart"><button class="btn addCartBtn" id="addToCart"><i class="fas fa-shopping-basket"></i>&nbsp;<span id="added"><?php echo $add_to_cart_label;?></span></button></div>
						...
						<div class="prdAdditionalInfo">
							<ul class="nav nav-tabs">
								<li class="nav-item"><a href="#prdDesc" class="nav-link active" data-toggle="tab"><?php echo $description_label;?></a></li>
 								<li class="nav-item "><a href="#prdReview" class="nav-link" data-toggle="tab"><?php echo $review_label;?></a></li>
							</ul>
			 ...
			 $(function(){
				...
				$('#quantity').keyup(function(){
					if(parseInt(this.value)<1 || parseInt(this.value)==''){
 						$('#success_message').html('<div class="alert alert-danger">Opps Crop quantity must be one or greater than one!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
						closePopup('success_message');
						$('#addToCart').attr('disabled', true);
					}else if(parseInt(this.value)>'<?php echo $product['quantity'];?>'){
  						$('#success_message').html('<div class="alert alert-danger">Opps Crop quantity exceeded!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
						closePopup('success_message');
						$('#addToCart').attr('disabled', true);
					}else{
