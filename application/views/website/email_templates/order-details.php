                                             ...
                                             <table width="570" cellpadding="10" cellspacing="0" style="border:1px solid #ddd">
                                                <thead style="background-color:#f2f2f2">
                                                   <tr>
                                                      ...
                                                      <th style="border:1px solid #ddd">Item Price</th>
                                                      <th style="border:1px solid #ddd">Quantity*Item Price</th>
                                                   </tr>
                                                </thead>
                                                <tbody>
                                                   <?php
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td align="center" style="border:1px solid #ddd"><?php if(is_file('./attachments/products/thumb/'.$product['image'])){  ?> <img style="height:50px;width:50px;" src="<?php echo base_url();?>attachments/products/thumb/<?php echo $product['image'];?>"><?php } ?></td>
                                                      <td style="border:1px solid #ddd"><?php  echo $product['name'];?></td>
                                                      <td style="border:1px solid #ddd"><?php echo $product['vendor_name'];?></td>
                                                      <td  align="right" style="border:1px solid #ddd"><?php echo $product['quantity'];?></td>
                                                      <td  align="right" style="border:1px solid #ddd">$<?php echo number_format($product['price'],2);?></td>
                                                      <td  align="right" style="border:1px solid #ddd">$<?php echo number_format(($product['price']*$product['quantity']),2);?></td>
                                                   </tr>
                                                   <?php
                                                ...
                                                <tr>
                                                   ...
                                                   <td  style="text-align:right" colspan="2">$<?php echo number_format($total_price,2);?></td>
                                                </tr>
                                                <?php
                                                   } 
                                                   ?>
                                             ...
                                             <table width="570" cellpadding="10" cellspacing="0" style="border:1px solid #ddd">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td style="border:1px solid #ddd"><?php echo $address['name'];?></td>
                                                      <td style="border:1px solid #ddd"><b>Email</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['email'];?></td>
                                                      
                                                   </tr>
                                                   <tr>
                                                   <td style="border:1px solid #ddd"><b>Phone</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['phone'];?></td>
                                                      <td style="border:1px solid #ddd"><b>Address Type</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['address_type'];?></td>
                                                   </tr>
                                                   <tr>
                                                      <td style="border:1px solid #ddd"><b>Country</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['country_name'];?></td>
                                                      <td style="border:1px solid #ddd"><b>State</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['state_name'];?></td>
                                                      
                                                   </tr>
                                                   <tr>
                                                   <td  style="border:1px solid #ddd"><b>City</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['city_name'];?></td>
                                                      <td style="border:1px solid #ddd"><b>Address</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['address'];?></td>
                                                      
                                                   </tr>
                                                   <tr>
                                                   <td style="border:1px solid #ddd"><b>Block</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['block'];?></td>
                                                      <td style="border:1px solid #ddd"><b>Landmark</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['landmark'];?></td>
                                                       
                                                   </tr>
                                                   <tr>
                                                      <td style="border:1px solid #ddd"><b>Zip Code</b></td>
                                                      <td style="border:1px solid #ddd"><?php echo $address['zip'];?></td>
                                                   </tr>
                                                </tbody>
                                             </table>
                                          </td>
