                  ...
                  <tr>
                     <td align="center">
                        ...
                        <table border="0" cellpadding="10" cellspacing="10" width="600" style="background: #fff; border:1px solid #f5811e;">
                           <tr>
                              <td colspan="2">Dear Admin, Some one has been requested for new product!
                              </td>
                           </tr>
                           <tr>
                              <td>Customer Name:</td>
                              <td><?php echo $this->session->userdata('customer_data')['first_name'].' '.$this->session->userdata('customer_data')['last_name'];?></td>
                           </tr>
                           <tr>
                              <td>Customer Email:</td>
                              <td><?php echo $this->session->userdata('customer_data')['email'];?></td>
                           </tr>
                           
                           <tr>
                              <td>Category Name:</td>
                              <td><?php echo $data_info['category_name'];?></td>
                           </tr>
                           <tr>
                              <td>Sub Category Name:</td>
                              <td><?php echo $data_info['sub_category_name'];?></td>
                           </tr>
                           <tr>
                              <td>Message:</td>
                              <td><?php echo $data_info['message'];?></td>
                           </tr>
                           <tr>
