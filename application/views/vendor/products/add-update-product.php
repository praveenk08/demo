          ...
          <form role="form" id="add_update_product_form">
            <div class="box-body">
              ...
              <div class="row d-flex flex-wrap">
                ...
                <div class="col-md-3 col-sm-6 form-group">
                  ...
                  <div class="set_language" id="set_language<?php echo $language['abbr'];?>">
                    ...
                    <input type="text" class="form-control name_suggestion12"  name="name<?php echo $language['abbr'];?>" id="name<?php echo $language['abbr'];?>" placeholder="Name" value="<?php if(isset($names[$language['abbr']]['name'])){echo $names[$language['abbr']]['name'];}?>">
                ...
                <div class="col-md-3 col-sm-6 form-group">
                  ...
                  <option value="">Select Category<span class="mandatory">*</span></option>
                    <?php
              ...
              <!--   <div class="col-md-2 col-sm-4 form-group">
                ...
                <div class="col-md-2 col-sm-4 form-group">
                  <label for="Maturity Date">Maturity From Date<span class="mandatory">*</span></label>
                ...
                <div class="col-md-2 col-sm-4 form-group">
                  <label for="Maturity Date">Maturity To Date<span class="mandatory">*</span></label>
                  <input type="text" class="form-control datepicker" readonly name="maturity_to_date" id="maturity_to_date" placeholder="Maturity To Date" value="<?php if($product['maturity_to_date']!='0000-00-00'){ echo date('d-m-Y',strtotime($product['maturity_to_date']));}?>">
                  <span id="maturity_date_error" class="error"></span>
                </div>
                <div class="col-md-2 col-sm-4 form-group">
            ...
            <div class="box-footer">
              ...
              <a href="<?php echo base_url('vendor-manage-products');?>" type="button" class="btn btn-danger">Cancel</a>
            </div>
          </form>
        </div>
      </div>      
...
<script type="text/javascript">  
  ...
  $(function(){
    ...
    var url="<?php echo base_url('vendor-copy-product/')?>"+$(this).attr('vendor_product_id');
    setTimeout(function(){
 ...
 if(id<1){
  $(".name_suggestion").keyup(function(){
    ...
    if($(this).val().length>0){
      $.ajax({
        type: "POST",
        url: '<?php echo base_url('vendor/Products/autoSuggestionProduct')?>',
        data:{'name':$(this).val()},
        beforeSend: function(){
    ...
    $('.product_main_image_crop').click(function (ev) {
      ...
      $('#gallery-spinner-regular').show();
        ...
        $product_main_image.croppie('result', {
          ...
          $.ajax({
            url: "<?php echo base_url();?>vendor/Products/uploadProductImage",
            type: "POST",
            data: {"image":resp},
            success: function (ajaxresponse) {
             var response=JSON.parse(ajaxresponse);
...
?>
   ...
   height: 150
    ...
    $('#add_update_product').click(function(){
     ...
     // uploadImage();
      ...
      var formData = new FormData(form);
		  $.ajax({
			  type: "POST",
			  url: "<?php  echo base_url('vendor-add-update-product');?>",
			  data: formData,
			  async: false,
		  	cache: false,
		  	contentType: false,
          ...
          closePopup('success_message');
					...
					setTimeout(function () {
          location.replace("<?php echo base_url('vendor-manage-products')?>");
					},500);
				}
    ...
    $('#deleteImage').click(function(){
        deleteDataImage('<?php echo base_url('vendor-delete-product-image')?>');
       $('#old_image').val('');
    });
    $('#deleteSecondaryImage').click(function(){
      ...
      if(id>0 && image!=''){
        ...
        $.ajax({
          url  :'<?php echo base_url('vendor-delete-product-secondary-image')?>', 
          type : 'POST',
