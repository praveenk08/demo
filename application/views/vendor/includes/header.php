...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                      <?php if(file_exists('attachments/users/thumb/'.$this->session->userdata('vendor_data')['image']) && !empty($this->session->userdata('vendor_data')['image'])){
                ?>
                
                <img src="<?php echo base_url('attachments/users/thumb/'.$this->session->userdata('vendor_data')['image'])?>" class="user-image" alt="User Image">
          ...
          <li class="dropdown user user-menu">
            ...
            <?php if(file_exists('attachments/users/thumb/'.$this->session->userdata('vendor_data')['image']) && !empty($this->session->userdata('vendor_data')['image'])){
                ...
                ?>
              <span class="hidden-xs"><?php echo $this->session->userdata('vendor_data')['first_name'];?> <?php echo $this->session->userdata('vendor_data')['last_name'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <?php if(file_exists('attachments/users/thumb/'.$this->session->userdata('vendor_data')['image']) && !empty($this->session->userdata('vendor_data')['image'])){
                ...
                <img src="<?php echo base_url('attachments/users/thumb/'.$this->session->userdata('vendor_data')['image'])?>" class="img-circle" alt="User Image">
                ...
                <p>
                <?php echo $this->session->userdata('vendor_data')['first_name'];?> <?php echo $this->session->userdata('vendor_data')['last_name'];?>
                 </p>
              </li>
              <!-- Menu Body -->
             <!-- <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('vendor-profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url('vendor-logout');?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel -->
      <a href="<?php echo base_url('vendor');?>" class="logo">
        <!--  mini logo for sidebar mini 50x50 pixels  -->
        <span class="logo-mini"><img src="<?php echo base_url('assets/frontend/images/logo.png');?>" style="max-height:25px;"></span>
        <!-- logo for regular state and mobile devices  -->
        <span class="logo-lg"><img src="<?php echo base_url('assets/frontend/images/logo.png');?>" style="max-height:70px;"></span>
      </a>
     <!-- <div class="user-panel" >
        ...
        <div class="pull-left info" style="display:none;">
          <p><a href="<?php echo base_url('vendor-profile');?>"><?php echo $this->session->userdata('vendor_data')['first_name'];;?> <?php echo $this->session->userdata('vendor_data')['last_name'];?></a></p>
         </div>
      </div>  -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->uri->segment(1)=='vendor-dashboard'){ ?>class="active"<?php } ?>>
         ...
         <li <?php if($this->uri->segment(1)=='vendor-manage-notifications'){ ?>class="active"<?php } ?>>
          <a href="<?php echo base_url('vendor-manage-notifications');?>"><i class="fa fa-link"></i> <span>Manage Notifications</span>
          </a>
        </li>

        <li <?php if($this->uri->segment(1)=='vendor-manage-reviews'){ ?>class="active"<?php } ?>>
          <a href="<?php echo base_url('vendor-manage-reviews');?>"><i class="fa fa-link"></i> <span>Manage Reviews</span>
          </a>
        </li>

        <li <?php if($this->uri->segment(1)=='vendor-manage-customers'){ ?>class="active"<?php } ?>>
          <a href="<?php echo base_url('vendor-manage-customers');?>"><i class="fa fa-link"></i> <span>Manage Customers</span>
          </a>
        </li>
        ...
        <li class="treeview">
          ...
          <li><a href="<?php echo base_url('vendor-manage-products');?>">Manage Products</a></li>
           </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url('vendor-manage-orders');?>">Manage Orders</a></li>
            </ul>
        </li>
