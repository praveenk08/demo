        ...
        <div class="addUpdateProduct">
          <form role="form" id="copy_product_product_form">
            <div class="box-body">
              ...
              <div class="row d-flex flex-wrap">
                ...
                <div class="col-md-2 col-sm-4 form-group">
                  ...
                  <input type="number" min="1" class="form-control" name="quantity" id="quantity" placeholder="Quantity" value="<?php echo $product['quantity'];?>">
                ...
                <div class="col-md-2 col-sm-4 form-group">
                   ...
                   <input type="number" min="1" class="form-control" name="price" id="price" placeholder="Price" value="<?php echo $product['price'];?>">
              ...
              <div class="row d-flex flex-wrap">
                <div class="col-md-4 form-group">
                  <label for="Product Gallery Image">Product Gallery Image</label>
                    ...
                    <?php if(count($secondary_images)>0){
                      foreach($secondary_images as $secondary_image){
                        ...
                        <li class="gbrgImg" id="<?php echo $secondary_image['id'];?>"><img style="height:100px;width:100px" src="<?php echo base_url('attachments/products/thumb/'.$secondary_image['image'])?>"/>
                          <a class="removeimg" onclick="removeSecondaryImage('<?php echo $secondary_image['id'];?>')"><span class="fa fa-close"></span></a>
            ...
            <div class="box-footer">
             <button type="button" class="btn btn-primary" id="copy_product_product"><?php  echo $button;?><span id="copy_product_product_loader"></span></button>
              ...
              <a href="<?php echo base_url('vendor-manage-products');?>" type="button" class="btn btn-primary">Cancel</a>
  ...
  $('#secondary_image_crop').click(function (ev) {
    ...
    $('#copy_product_product').click(function(){
     buttonEnableDisable('copy_product_product', 1);
		...
		$.ajax({
			type: "POST",
			url: "<?php  echo base_url('vendor-copy-save-product');?>",
			data: formData,
			async: false,
			cache: false,
			contentType: false,
