						...
						<tr>
							<td align="center">
								<table border="0" cellpadding="10" cellspacing="0" width="600">
									<tr>
									<td align="center"><a href=""><img src="http://mahaseel.us.tempcloudsite.com/assets/frontend/images/logo.png" style="width: 150px;"></a></td>
									</tr>
								</table>
								<table border="0" cellpadding="10" cellspacing="10" width="600" style="background: #fff; border:1px solid #f5811e;">
                        <tr>
             <td colspan="4">Dear <?php echo $template['name'];?>,<br>
             </td>
          </tr>
          <tr>
             <td colspan="4"><?php echo $template['message'];?></td>
          </tr><td align="right">Team, <br/> <?php echo base_url(); ?></td>
				</tr>
									</table>
									</td>
						</tr>
