    ...
    <!-- Sidebar user panel -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          ...
          <li><a href="<?php echo base_url('admin-manage-sliders');?>">Sliders</a></li>
          <li><a href="<?php echo base_url('admin-manage-pages');?>">Pages</a></li>
          <li><a href="<?php echo base_url('admin-manage-faqs');?>">Faq</a></li>
          <li><a href="<?php echo base_url('admin-manage-teams');?>">Our Team</a></li>
          <li><a href="<?php echo base_url('admin-manage-our-services');?>">Our Services</a></li>
          <li><a href="<?php echo base_url('admin-manage-work-process');?>">Work Process</a></li>
          <li><a href="<?php echo base_url('admin-website-settings');?>">Website Settings</a></li>
          <li><a href="<?php echo base_url('admin-manage-facilities');?>">Facilities</a></li>
          <li><a href="<?php echo base_url('admin-manage-email-templates');?>">Email Templates</a></li>
          <li><a href="<?php echo base_url('admin-manage-calculations');?>">Calculations</a></li>
           <li><a href="<?php echo base_url('admin-manage-student');?>">Student</a></li>
            </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="<?php echo base_url('admin-manage-category');?>">Categories</a></li>
          <li><a href="<?php echo base_url('admin-manage-unit');?>">Units</a></li>
          <li><a href="<?php echo base_url('admin-manage-products');?>">Products</a></li>
            </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <li><a href="<?php echo base_url('admin-manage-subscribers');?>">Subscribers</a></li>
          <li><a href="<?php echo base_url('admin-manage-contact-us');?>">Contact Us</a></li>
          <li><a href="<?php echo base_url('admin-manage-service-categories');?>">Service Categories</a></li>
          <li><a href="<?php echo base_url('admin-manage-services');?>">Service Provider Services</a></li>
          <li><a href="<?php echo base_url('admin-manage-reviews');?>">Reviews</a></li>
          <li><a href="<?php echo base_url('admin-manage-orders');?>">Orders</a></li>
