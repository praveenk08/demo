...
<input type="hidden" id="selected_delivery_boy" value="0">
</body>
</html>
<div class="modal fade" id="removeProfilePhoteModalPopup" role="dialog">
  ...
  <div class="modal fade" id="deleteModalPopup" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
			<input type="hidden" name="action_id" id="action_id">
          <button type="button" class="btn btn-danger" id="delete_record">Yes</button>&nbsp;&nbsp;&nbsp;
  ...
  <div class="modal fade" id="deleteImageModalPopup" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" id="deleteImage">Yes</button>&nbsp;&nbsp;&nbsp;
          <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
        </div>
      </div>
  ...
  <div class="modal fade" id="deleteBannerImageModalPopup" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="text-center" style="font-size: 18px;"><strong id="delete_banner_image_confirmation_message"></strong></div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" id="deleteBannerImage">Yes</button>&nbsp;&nbsp;&nbsp;
          <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
        </div>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" id="deleteSecondaryImage">Yes</button>&nbsp;&nbsp;&nbsp;
          <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
        </div>
      </div>
...
var small_loader='<div class="small_loader"><i class="fa fa-spinner fa-spin"></i></div>';
var button_loader='<span class="button_loader"><i class="fa fa-spinner fa-spin"></i></span>';
var imageAllowedTypes = ['jpg', 'jpeg', 'png']; 
