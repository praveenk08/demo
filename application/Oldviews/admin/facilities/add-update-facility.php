       ...
       <form role="form" id="add_update_facility_form">
              ...
              <div id="success_message"><?php if($this->session->flashdata('success_message')){ ?> 
                ...
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?php echo $facility['name'];?>">
              ...
              <a href="<?php echo base_url('admin-manage-facilities');?>" type="button" class="btn btn-primary">Cancel</a>
              </div>
            </form>
            </div>
          </div>
