							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="detailContent">
										...
										<div class="prName"><strong>Service Category: <?php echo $service['category_name'];?></strong></div>
										<div class="prName"><strong>Provider Name: <?php echo $service['provider_name'];?></strong></div>
