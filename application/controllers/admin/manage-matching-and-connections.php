...
"scrollX": true,
      ...
      "columnDefs": [
        {
          ...
          {
            "render": function ( data, type, row ) {
            var html ='<a href="javascript:void(0);" onClick="deleteRecord('+data+');" title="Delete matching_and_connections message" class="btn btn-danger btn-sm">';
    ...
    $('#delete_record').click(function(){
     ...
     function changeContactUsStatus(id,status){
	    if(id>0){
        changeDataStatus('changeContactUsStatus',id,status,'<?php echo base_url('admin-change-matching_and_connections-status')?>',matching_and_connections_list_table);
    }
  } 
